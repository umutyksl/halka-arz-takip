...
# Mevcut Verilerin (Geçmiş Hisselerin)
initial_data = [
...
# Verileri Session State'de tutarak "otomatik kayıt" hissi veriyoruz
...
st.metric(label="🚀 Toplam Net Kazanç (3 Hesap)", value=f"{toplam_kazanc:.2f} TL")

st.subheader("📋 Kar Tablosu")
